...
public class Registro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 230, 60, -1));
        getContentPane().add(jTextPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 260, 130, 30));

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setText("Modelo");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 230, -1, -1));
        getContentPane().add(jTextModelo, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 260, 130, 30));

        jRadioAuto.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jRadioAuto.setText("Automatico");
        getContentPane().add(jRadioAuto, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, -1, 20));

        jRadioManual.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jRadioManual.setText("Manual");
        getContentPane().add(jRadioManual, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 280, -1, 20));

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel7.setText("Transmision");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, -1, 20));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 130, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel10.setText("Marca");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 130, -1, -1));
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 130, -1, -1));

        ComboBoxTipoMotor.setName("combotipoMotor"); // NOI18N
        ComboBoxTipoMotor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ComboBoxTipoMotorActionPerformed(evt);
            }
        });
        getContentPane().add(ComboBoxTipoMotor, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 130, 30));

        getContentPane().add(jComboBoxTipoCarro, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 160, 130, 30));

        getContentPane().add(jComboBoxMarca, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 160, 130, 30));
        ...
        getContentPane().add(jComboBox4, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 160, 60, 30));
        ...
        getContentPane().add(jComboBoxAnio, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 160, 80, 30));
        ...
        getContentPane().add(jButtonAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 410, 110, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 410, 110, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, 230, -1));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 290, -1, -1));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 410, 170, -1));
    ...
    private void ComboBoxTipoMotorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboBoxTipoMotorActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ComboBoxTipoMotorActionPerformed
